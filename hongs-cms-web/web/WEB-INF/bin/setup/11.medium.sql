...
CREATE TABLE `a_medium_comment` (
  `id` CHAR(14) NOT NULL,
  `prev_id` CHAR(14) DEFAULT NULL, /* 回复哪 */
  `mate_id` CHAR(14) DEFAULT NULL, /* 回复谁 */
  `user_id` CHAR(14) NOT NULL,
  `link_id` CHAR(14) NOT NULL,
...
CREATE TABLE `a_medium_statist` (
  ...
  `link_id` CHAR(14) NOT NULL,
  `link` VARCHAR(28) NOT NULL,
  `comment_count` INTEGER UNSIGNED DEFAULT '0', /* 评论量 */
  `dissent_count` INTEGER UNSIGNED DEFAULT '0', /* 举报量 */
  `impress_count` INTEGER UNSIGNED DEFAULT '0', /* 阅读量 */
  `endorse_count` INTEGER UNSIGNED DEFAULT '0', /* 评价量 */
  `endorse_score` INTEGER UNSIGNED DEFAULT '0', /* 评分, endorse.score 总和 */
  `ctime` INTEGER UNSIGNED DEFAULT NULL,
  `mtime` INTEGER UNSIGNED DEFAULT NULL,
  PRIMARY KEY (`id`)
);
