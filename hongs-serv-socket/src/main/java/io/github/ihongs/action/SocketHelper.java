    ...
    public OutputStream getOutputStream() {
        ...
        if (null != sess) {
            try {
                ...
                throw new HongsExemption(0x1110, "Can not get socket stream.", ex);
            }
        }
    ...
    public Writer getOutputWriter() {
        ...
        if (null != sess) {
            try {
                ...
                throw new HongsExemption(0x1110, "Can not get socket writer.", ex);
            }
        }
    ...
    public void responed() {
        ...
        if (null != sess) {
            try {
                ...
                throw new HongsExemption(0x1110, "Can not send to remote.", ex );
            }
        } else {
                throw new HongsExemption(0x1110, "Session does not exist." /**/);
        }
    }
